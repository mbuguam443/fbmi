...
CHURCH_NAME = os.environ.get('CHURCH_NAME', 'Fruitful Brethren Ministry International')
CHURCH_SHORT_NAME = os.environ.get('CHURCH_SHORT_NAME', 'F.B.M.I.')
CHURCH_EMAIL = os.environ.get('CHURCH_EMAIL', 'info@fbministry.org')
