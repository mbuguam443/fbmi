...
<html>
<head>
    <title>FBMI Church - Management</title>
    <style>
        body { font-family: Arial, sans-serif; max-width: 800px; margin: 50px auto; padding: 20px; }
        h1 { color: #6794A6; }
        .btn { display: inline-block; padding: 10px 20px; margin: 10px; background: #6794A6; color: white; text-decoration: none; border-radius: 5px; }
        .btn:hover { background: #557a8a; }
