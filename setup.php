...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-migrate { background: #6794A6; color: white; }
        .btn-static { background: #28a745; color: white; }
        .btn-seed { background: #BAA883; color: white; }
        .btn-all { background: #BF2D30; color: white; font-size: 18px; }
